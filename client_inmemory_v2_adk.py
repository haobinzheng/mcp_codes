...
Mirrors the behavior of client_inmemory_v2.py with LlmAgent, Runner, and McpTool
instead of the google-genai chat + manual tool loop. Does not import client_inmemory_v2.
"""
